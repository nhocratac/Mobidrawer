...
const handleStyles = {
  topLeft:
    "cursor-nw-resize w-[10px] h-[10px] absolute bg-white border-2 border-black rounded-full top-[-5px] left-[-5px]",
  topRight:
    "cursor-ne-resize w-[10px] h-[10px] absolute bg-white border-2 border-black rounded-full top-[-5px] right-[-5px]",
  bottomLeft:
    "cursor-sw-resize w-[10px] h-[10px] absolute bg-white border-2 border-black rounded-full bottom-[-5px] left-[-5px]",
  bottomRight:
    "cursor-se-resize w-[10px] h-[10px] absolute bg-white border-2 border-black rounded-full bottom-[-5px] right-[-5px]",
};
...
const RNDBase = ({ parentScale, children }) => (
  ...
  >
    <Box scale={parentScale}>{children}</Box>
