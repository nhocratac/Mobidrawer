      ...
      <div className="container px-5 mx-auto relative h-full text-[16px]">
        <div className="flex justify-between items-center h-full pl-[40px] pr-[40px]">
          ...
          <motion.div
            ...
            className="absolute h-svh w-full top-0 left-0 bg-black/50 backdrop-blur-lg lg:!hidden"
            onClick={(e) => {
              if (
          ...
          >
            <motion.div
              ...
              className="max-w-[320px] w-full h-full bg-white flex flex-col"
            >
                ...
                <div className="px-[24px] py-[32px]">
                  {user ? (
                    ...
                    <div className="flex flex-col gap-4 mt-8 w-full">
                      ...
                      <Button className="p-10 text-3xl bg-gradient-to-b from-blue-500 to-blue-600 text-white hover:opacity-90 transition-opacity duration-200" onClick={() => router.push("/register")}>
                        Đăng ký miễn phí
                      </Button>
                    </div>
                  )}
