...
import CanvasDrawingOverlay, { getMaskData } from "@/components/CanvasDrawingOverlay/CanvasDrawingOverlay";
import BoxResizeable from "@/components/BoxResizable/BoxResizeable"
...
const PlayGroundPage = ({ params }: IPLayGroundProps) => {
    ...
    return (
        <div className="bg-transparent w-full h-screen flex flex-col gap-4">
            ...
            <BoxResizeable imageUrl={imageUrl} />


            {/* this use for inPaint image */}
            {/* <CanvasDrawingOverlay imgUrl={"http://localhost:4000/test.png"} width={200} height={200} />
