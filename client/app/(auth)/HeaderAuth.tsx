...
function HeaderAuth() {
    ...
    return (
        <header className='fixed top-0 left-0 right-0 z-50 lg:h-[96px] h-[54px] bg-white text-[black] border border-b-[#444749] lg:px-[24px] lg:py-[8px] flex justify-between items-center' >
